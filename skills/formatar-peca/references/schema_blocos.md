...
|| `memoria_calculo` | `linhas_creditos` | **Memória de cálculo judicial** (preset). Tabela formatada para cálculo de créditos com atualização monetária/juros. Colunas fixas: "Parcela / Crédito", "Valor Histórico", "Correção Desde", "Juros Desde", "Valor Atualizado". Alinhamento: parcela à esquerda, demais à direita. Garante consistência em múltiplos créditos. ✅ 2026-09-02 |
