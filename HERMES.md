...
Antes de uma operação jurídica, leia `AGENTS.md`, `CLAUDE.md`, `referencias/decisoes-roteamento-motores-2026-08-30.md` e a skill aplicável. Não trate esta instrução como substituta desses contratos.
